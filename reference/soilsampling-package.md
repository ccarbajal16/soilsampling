...
The soilsampling package provides methods for designing and optimizing
soil sampling schemes: spatial coverage sampling, simple random
sampling, stratified random sampling, composite sampling, maxvol optimal
design, and tools for choosing a sample size, refining an existing
design, and replacing inaccessible sites. Spatial operations use sf.
